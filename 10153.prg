...
SELECT i, ci, 1 AS q FROM MyPlan469 GROUP BY i, ci INTO CURSOR Cur1
...
SELECT * FROM table10153_37 WHERE EXISTS(SELECT * FROM PerDSE103; 
WHERE PerDSE103.dse = table10153_37.kod_det ) ORDER BY kod_det INTO TABLE My10153
